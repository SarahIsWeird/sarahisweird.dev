...
is the reduce filter. I'm going to share the ins and outs of it with you here, as well as some theory behind images.
The goal is that even if you haven't worked with images yet, you still can get a feel for how this all fits together.
...
<div className="two-images">
    <div>
        <img src="/assets/reduce-filter/doggo.png" alt="Original image" />
        <span>Original</span>
    </div>
    <div>
...
<div className="two-images">
    <div>
        ...
        <span>The image reduced with $n_r=3$, $n_g=4$ and $n_b=3$</span>
    </div>
</div>
